...
import tn.spring.projet.interfaces.IAideservice;
import tn.spring.projet.repository.AideRepository;
...
public class AideController {
	...
	// http://localhost:8085/SpringMVC/Aide/retrieve-Aide
		...
		// http://localhost:8085/SpringMVC/Aide/update-Aide
				...
				public List<Aide> searchAide(@PathVariable("keyword") String keyword){
					String x ="";
					if(keyword != null && keyword != x){
						return opRaip.search(keyword);
					}
					
					return opRaip.findAll();
				}
